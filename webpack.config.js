...
module.exports = {
  entry: path.resolve(__dirname, "./joonasreactpage-src/index.js"),
  module: {
    rules: [
      {
        test: /\.(js|jsx)$/,
  ...
  output: {
    path: path.resolve(__dirname, "./joonasreactpage"),
    filename: "bundle.js",
  },
  ...
  devServer: {
    ...
    contentBase: path.resolve(__dirname, "./joonasreactpage"),
    hot: true,
  },
};
